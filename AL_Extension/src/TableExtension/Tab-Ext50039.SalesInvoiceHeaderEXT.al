TableExtension 50039 "Sales Invoice HeaderEXT" extends "Sales Invoice Header"
{
    fields
    {
        ...
        field(50100; "Date Intèret Moratoire"; Date)
        {
            Caption = 'Date Intèret Moratoire';
            Description = 'BSK24/04/2012';
        }
        ...
        field(8001407; "Print Document Type"; Option)
        {
            Caption = 'Print Document Type';
            OptionCaption = ',Proforma,Unposted Invoice,Unposted Credit Memo,,Return Order,,,,,Posted Credit Memo,Prepayment Request,Invoice Request';
            OptionMembers = Quote,"Order",Invoice,"Credit Memo",,"Return Order",,,,,"Posted Credit Memo","Prepayment Request","Invoice Request";
        }
        ...
        {
            Caption = 'Order Type';
            OptionCaption = ' ,Supply Order';
            OptionMembers = " ","Supply Order";
        }
        ...
        field(8003986; "Progress Degree"; Code[10])
        {
            ...
            TableRelation = "Document Progress Degree";
        ...
        field(8003992; "Reverse Prepmt. Cr. Memo No."; Code[20])
        {
            Caption = 'N° avoir extourne acompte';
    ...
    begin
        //+ONE+PREPAYMENT
        lPrepaymentManagement.DeleteSalesInvoice(Rec);
        //+ONE+PREPAYMENT//
    end;
    ...
    begin
        with lNaviBatSetup do begin
            ...
            case pFieldNumber of
                ...
                //     8003951:
                //      IF "Free Text Name 1" <> '' THEN
                //        lReturnText := '1,5,,'+ "Free Text Name 1"
                //      ELSE
                //        lReturnText := '1,5,,'+ Rec.FIELDCAPTION("Free Text 1");
                //     8003952:
                //      IF "Free Text Name 2" <> '' THEN
                //        lReturnText := '1,5,,'+ "Free Text Name 2"
                //      ELSE
                //        lReturnText := '1,5,,'+ Rec.FIELDCAPTION("Free Text 2");
                //     8003953:
                //      IF "Free Text Name 3" <> '' THEN
                //        lReturnText := '1,5,,'+ "Free Text Name 3"
                //      ELSE
                //        lReturnText := '1,5,,'+ Rec.FIELDCAPTION("Free Text 3");
                //     8003954:
                //      IF "Free Text Name 4" <> '' THEN
                //        lReturnText := '1,5,,'+ "Free Text Name 4"
                //      ELSE
                //        lReturnText := '1,5,,'+ Rec.FIELDCAPTION("Free Text 4");
                //     8003955:
                //      IF "Free Text Name 5" <> '' THEN
                //        lReturnText := '1,5,,'+ "Free Text Name 5"
                //      ELSE
                //        lReturnText := '1,5,,'+ Rec.FIELDCAPTION("Free Text 5");
                /*
                     8003956:
