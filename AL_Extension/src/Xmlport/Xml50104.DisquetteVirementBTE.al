//HS
xmlport 50104 "Disquette Virement BTE"
{
    ...
    //             textattribute(CodeEspace20)
    //             {
    //                 Width = 20;
    //             }

    //             textattribute(DateOp2) // pour éviter doublon
    //             {
    //                 Width = 8;
    //             }
    ...
    //             textattribute(CodeEspace3_2) // renommé pour éviter doublon
    //             {
    //                 Width = 3;
    //             }
    ...
    //             textattribute(CodeEspace3_3) // renommé pour éviter doublon
    //             {
    //                 Width = 3;
    //             }
    ...
    //             textattribute(CodeZoneLibre139)
    //             {
    //                 Width = 139;
    //             }
