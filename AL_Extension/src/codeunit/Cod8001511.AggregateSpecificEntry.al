Codeunit 8001511 "Aggregate, Specific Entry"
{
    //GL2024  ID dans Nav 2009 : "8001311"
    // #6572 SD 25/03/10
    // //STATSEXPLORER STATSEXPLORER 01/10/01 Aggregate, Specific Entry
            ...
            with Entry do
                repeat
                    ...
                    if (Quantity <> 0) or (Amount <> 0) or ("Additional-Currency Amount" <> 0) then begin
                        ...
                        StatisticAggregate1."Entry Type" := TextType[90];
                        ...
                        if not StatsExplorerTools.SearchAndModifyAggregate(StatisticAggregate1, StatisticAggregate2, SearchDim[90], 90) then begin
