Codeunit 8004005 "Aggregate, Prepay ledger"
{
    ...
    var
        ...
        //GL2024 License
        Entry: Record "Prepay Ledger Entry";
        "Code": Record Code;
    ...
    begin
        Entry.Reset;
        Entry.SetCurrentkey("Employee No.", "Prepay Reason Code", "From Date");
        ...
        if not Entry.IsEmpty then begin
            ...
            with Entry do repeat
                              ...
                              if (Quantity <> 0) then begin
                                  ...
                                  StatisticAggregate1."Reason Code" := "Prepay Reason Code";
                                  StatisticAggregate1.Quantity := Quantity;
                                  //      IF SearchDim[52] THEN
                                  //         StatsExplorerTools.SearchLedgerEntryDimension(StatisticAggregate1,xxx,"Entry No.");
