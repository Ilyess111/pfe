Codeunit 50003 "Universal Excel Importer OK"
{
    // //
    ...
    begin
        ...
        //DYS  ReadSelectedSheetArea(fileName, sheetName, StrSubstNo('>%1', headerRow), columnFilter);
    ...
    */
    ...
    var
    //DYS cdu 412 supprimer
    // DialogWindow: Codeunit 412;
    begin
   ...
   */
    ...
    var
        //GL2024 FieldMapDialog: Page 99991;
        i: Integer;
    begin
        if not testBit(31, ImporterOptions) then begin   // d31=1 -> silent mode
                                                         //GL2024    Clear(FieldMapDialog);
            Commit;

            //GL2024  FieldMapDialog.setParameters(tableNo, ImporterOptions, ColFilter);
            //GL2024     FieldMapDialog.LookupMode(true);

            /*  //GL2024  if FieldMapDialog.RunModal <> Action::LookupOK then begin
                 clearExcel;
                 Clear(FieldMapDialog);
                 Error(Text008);
             end;*/

            //GL2024  ImporterOptions := FieldMapDialog.getOptions;
        end;
