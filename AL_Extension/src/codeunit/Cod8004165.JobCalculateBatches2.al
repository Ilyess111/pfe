Codeunit 8004165 "Job Calculate Batches2"
{
    ...
    begin
        ...
        if JobPlanningLine.Find('-') then
            repeat
            /*  //GL2024        if not JobPlanningLine.Transferred then begin
    ...
    procedure InsertDiffBuffer(var JobLedgEntry: Record "Job Ledger Entry"; var JobPlanningLine: Record "Job Planning Line"; LineType: Option Schedule,Usage; CurrencyType: Option LCY,FCY)
    begin
    ...
    procedure GetCurrencyCode(var Job: Record Job; Type: Option Cost,Price; CurrencyType: Option LCY,FCY): Text[50]
    var
