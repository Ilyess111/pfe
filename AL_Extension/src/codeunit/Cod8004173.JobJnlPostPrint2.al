Codeunit 8004173 "Job Jnl.-Post+Print2"
{
    ...
    begin
        with JobJnlLine do begin
            ...
            lJobJnlLine.SetFilter(lJobJnlLine."Attached to Line No.", '<>0');
    ...
    begin
        ...
        if lJobJnlLine.Find('-') then begin
            repeat
                if lJobJnlLine.Quantity <> 0 then begin
                    ...
                    lJobJnlLine.Quantity := -lJobJnlLine.Quantity;
                    lJobJnlLine.Modify;
                end;
