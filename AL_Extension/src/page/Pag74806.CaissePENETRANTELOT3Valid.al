//GL2024
// page 74806 "Caisse PENETRANTE LOT3 Validé"
// {//GL2024  ID dans Nav 2009 : "39004806"
...
//     SourceTableView = WHERE("Payment Class" = CONST('CAISSEEXT'), Valider = CONST(true), "Caisse Chantier" = CONST(false), "N° Affaire" = FILTER('PENETRANTE_LOT3' | ''));
//     ApplicationArea = All;
