Page 50254 "Subform Décision augmentation"
{
    PageType = ListPart;
    SourceTable = "Decision augmentation salaire";
    SourceTableView = sorting("N° Decision")
                      where(Validé = filter(true));
    ApplicationArea = All;
    Caption = 'Subform Décision augmentation';
