// page 52049019 "Entete Pointage Jour. Valider"
// {
//     //GL2024  ID dans Nav 2009 : "39001547"
//     DeleteAllowed = true;
//     InsertAllowed = true;
//     ModifyAllowed = true;
//     PageType = Card;
...
//     Caption = 'Entete Pointage Jour. Valider';
//     layout
//     {
//         area(content)
//         {
...
//                 }
//             }
//             part("Ligne Pointage Jour. Valider"; "Ligne Pointage Jour. Valider")
//             {
//                 ApplicationArea = all;
...
//                     RecGEmp.SETRANGE(Affectation, LAffecatation);
