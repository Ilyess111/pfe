page 50093 "Caisse Comptable Chantier"
{
    // //>>>MBK:05/02/2010: Référence chèque
    // // << HJ DSFT 21-01-2009: Gestion des Utilisateurs

    Caption = 'Caisse Comptable Chantier';
    DeleteAllowed = false;
    PageType = Card;
    RefreshOnActivate = true;
    SourceTable = 10865;
    SourceTableView = WHERE("Payment Class" = CONST('ESPECE COMPTABLE EMIS'), "Caisse Chantier" = CONST(true));
    ApplicationArea = all;
    ...
    layout
    {
        area(content)
        {
            ...
            field("Solde Caisse"; rec."Solde Caisse Chantier")
            {
                ApplicationArea = all;
                Editable = false;
                Style = Unfavorable;
            ...
            part(Lines; "Ligne Paiement Chantier C")
            {
    ...
    actions
    {
        area(Promoted)
        {
            ...
            group("Posting")
            {
                ...
                actionref("Générer fichier1"; "Generate file")
                {
                ...
                actionref("Approuver Brouillard1"; "Approuver Brouillard")
                {

                }
                actionref("Annuler Approbation Brouillard1"; "Annuler Approbation Brouillard")
                {
        ...
        area(processing)
        {
            ...
            group("P&osting")
            {
                ...
                action("Annuler Approbation Brouillard")
                {
                    Caption = 'Annuler Approbation Brouillardd';
                    ...
                    begin
                        ...
                        IF NOT CONFIRM(Text017) THEN EXIT;
                        RecPaymentLine.SETRANGE("No.", rec."No.");
                        IF RecPaymentLine.FINDFIRST THEN
                            REPEAT
                ...
                action(Nouveau)
                {
                    ...
                    begin
                        ...
                        IF RecPaymentClass.GET(GeneralLedgerSetup."Type Reg. Caisse Cpt") THEN;
                        ...
                        RecEntetePayement.VALIDATE("Payment Class", GeneralLedgerSetup."Type Reg. Caisse Cpt");
                        RecEntetePayement.VALIDATE("Account Type", RecEntetePayement."Account Type"::"Bank Account");
                        RecEntetePayement.VALIDATE("Account No.", GeneralLedgerSetup."Caisse CPT");
                        ...
                        rec.SETRANGE("Payment Class", GeneralLedgerSetup."Type Reg. Caisse Cpt");
                        rec.SETRANGE("Account No.", GeneralLedgerSetup."Caisse CPT");
                    end;
                }
            }
        }
    ...
    var
        ...
        "-HJ-": Integer;
        RecAutorisationEtapes: Record 50012;
        ...
        Text012: Label 'Approuver Brouillard ?';
