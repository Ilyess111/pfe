//GL3900 
// page 72118 "Fiche OT Lancé"
// {
//     //GL2024  ID dans Nav 2009 : "39002118"
//     PageType = Card;
//     SourceTable = OT;
...
//                 {
//                     ApplicationArea = all;
//                     CaptionClass = Text19028832;
//                 }
//                 label(text4)
//                 {
//                     ApplicationArea = all;
//                     CaptionClass = Text19047697;
//                 }
...
//                     trigger OnAction()
//                     var
//                         DocPrint: Codeunit "Document-Print GMAO";
//                     begin
//                         /*order.RESET;
//                         order.SETFILTER(order."code OT","code OT");
//                         IF order.FIND('-') THEN
//                          REPORT.RUNMODAL(90010,TRUE,FALSE,order);
//                         */
//                         DocPrint.PrintWorkOrder(Rec);
...
//         camm: Codeunit "Consumption treatment";
//         order: Record OT;
//         sheet: Record BT;
