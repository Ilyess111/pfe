// Page 50122 "Ligne Rappels Caisse"
// {
//     Editable = false;
//     PageType = Card;
//     SourceTable = "Payment Line";
//     SourceTableView = sorting("Due Date")
//                       where(Caisse = const(true), "Code Opération" = filter('16*'), "Posting Date" = filter(>= '01/01/21'));
//     ApplicationArea = all;
//     Caption = 'Ligne Rappels Caisse';
//     UsageCategory = Lists;
//     layout
...
//         Text19037651: label 'Rappels Ligne Caisse';
// }
