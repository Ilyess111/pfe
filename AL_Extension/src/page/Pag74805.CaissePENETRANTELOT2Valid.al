//GL2024
// page 74805 "Caisse PENETRANTE LOT2 Validé"
// {//GL2024  ID dans Nav 2009 : "39004805"
//     // //>>>MBK:05/02/2010: Référence chèque
//     // // << HJ DSFT 21-01-2009: Gestion des Utilisateurs

//     Caption = 'Caisse Journaliére PENETRANTE LOT2 Validé';
//     DeleteAllowed = false;
//     InsertAllowed = false;
//     PageType = Card;
//     RefreshOnActivate = true;
//     SourceTable = "Payment Header";
//     SourceTableView = WHERE("Payment Class" = CONST('CAISSEEXT'), Valider = CONST(true), "Caisse Chantier" = CONST(false), "N° Affaire" = FILTER('PENETRANTE_LOT2' | ''));
//     ApplicationArea = All;
