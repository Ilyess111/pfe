// GL2024
// page 50314 "Liste Caisse Extra OACA"
// {
//     //GL2024 NEW PAGE
//     Caption = 'Liste Caisse Journaliére OACA';
//     DeleteAllowed = true;
//     PageType = List;
//     RefreshOnActivate = true;
//     SourceTable = "Payment Header";
//     SourceTableView = WHERE("Payment Class" = CONST('CAISSEEXT'), Valider = CONST(false), "Caisse Chantier" = CONST(false), "N° Affaire" = FILTER(= 'AEROP-JERBA-MATMATA' | ''));
//     ApplicationArea = all;
//     CardPageId = "Caisse Extra OACA";
//     UsageCategory = lists;
