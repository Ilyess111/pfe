// Page 50039 "Ligne Alimentaion Caisse"
// {
//     // //>>>MBK:05/02/2010: Référence chèque

//     AutoSplitKey = true;
//     Caption = 'Ligne Alimentaion Caisse';
//     DelayedInsert = true;
//     PageType = listPart;
...
//                     OptionCaption = 'General,Customer,Vendor,Bank or Cash,Fixed Asset,Item charge,Employee';
//                     Visible = false;
//                 }
...
//                     begin
//                         MotifDepense.SetRange("Alimentation Caisse", true);
...
//                             rec.Caisse := true;
//                             rec."Type Caisse" := 1;    // 1: Alimentation Caisse
//                         end;
//                     end;

//                     trigger OnValidate()
//                     begin
//                         if MotifDepense.Get(rec."Code Opération") then;
//                         rec.Validate("Type de compte", rec."type de compte"::"Frais annexe");
//                         rec.Validate("Code compte", 'CC-DIVERS');
//                         rec.Libellé := MotifDepense.Description;
//                         rec.Caisse := true;
...
//                         if rec."Numero Seq" = '' then rec."Numero Seq" := NoSeriesManagment.GetNextNo('SEQEXT', Today, true);
//                     end;
//                 }
...
//                     Caption = 'Card';
//                     Image = EditLines;
//                     RunObject = Page "Payment Slip Subform 2";
//                     ShortCutKey = 'Maj+F7';
//                 }
//             }
//         }
