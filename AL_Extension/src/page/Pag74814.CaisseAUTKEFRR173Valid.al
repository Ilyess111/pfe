//GL2024
// page 74814 "Caisse AUT KEF RR173 Validé"
// {//GL2024  ID dans Nav 2009 : "39004814"
...
//     SourceTableView = WHERE("Payment Class" = CONST('CAISSEEXT'), Valider = CONST(true), "Caisse Chantier" = CONST(false), "N° Affaire" = FILTER('CHANTIER_KEF_RR173' | ''));
//     ApplicationArea = all;
