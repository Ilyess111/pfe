// page 52049005 "Advances a la Caisse"
// {
//     //GL2024  ID dans Nav 2009 : "39001533"
//     Caption = 'Avance a la caisse';
//     PageType = Card;
//     SourceTable = "Loan & Advance";
//     SourceTableView = where(Type = filter(Advance), "Generer Par Caisse" = const(true));
//     /*  ApplicationArea = all;
...
//                             Report.RunModal(Report::"Payroll : Post Loan & Advanc @", true, true, LoanAdvance);
//                         end;
...
//                         Report.Run(39001405, false, false, LoanAdvance);
