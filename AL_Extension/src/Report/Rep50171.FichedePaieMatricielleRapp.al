report 50171 "Fiche de Paie Matricielle Rapp"
{
    // // 106
    // DefaultLayout = RDLC;
    // RDLCLayout = './Layouts/FichedePaieMatricielleRapp.rdl';
    ...
    //             {
    //             }
    //             column(Prime_De_Rendement_2019Caption; Prime_De_Rendement_2019CaptionLbl)
    //             {
    //             }
    ...
    //                     CurrReport.Skip();
    //                 // CurrReport.SHOWOUTPUT(FALSE);
    //                 IF "Basis salary" <> 0 THEN IntCompteur += 1;
    //             end;
    //         }
    ...
    //             DataItemTableView = SORTING("No.", Employee)
    //                                     ORDER(Ascending);
    //             column(Salary_Lines6_Advances; Advances)
    //             {
    //             }
    ...
    //                 DecimalPlaces = 3 : 3;
    //             }
    //             column("Total_Avance___CongéCaption"; Total_Avance___CongéCaptionLbl)
    //             {
    //             }
    ...
    //                 IF Advances <> 0 THEN IntCompteur += 1;
    //                 if "Salary Lines".Advances = 0 then
    //                     CurrReport.Skip();
    //                 // CurrReport.SHOWOUTPUT("Salary Lines".Advances <> 0);
    //                 IF CurrReport.SHOWOUTPUT THEN
    //                     LinesPrinted := LinesPrinted + 1;
    ...
    //             end;
    //         }
    //         dataitem("Contribution Social"; "Salary Lines")
    //         {
    //             DataItemLink = "No." = FIELD("No."),
    //                                Employee = FIELD(Employee);
    //             DataItemTableView = SORTING("No.", Employee)
    //                                     WHERE("Contribution Social" = FILTER(<> 0));
    //             column(Contribution_Social__Contribution_Social_; "Contribution Social")
    //             {
    //                 DecimalPlaces = 3 : 3;
    //             }
    ...
    //             {
    //             }
    //             column(Contribution_Social_No_; "No.")
    //             {
    //             }
    //             column(Contribution_Social_Employee; Employee)
    //             {
    //             }
    //             trigger OnAfterGetRecord()
    //             begin
    ...
    //                 if "Salary Lines"."Contribution Social" = 0 then
    //                     CurrReport.Skip();
    //                 // CurrReport.SHOWOUTPUT("Salary Lines"."Contribution Social" <> 0);
    //                 IF CurrReport.SHOWOUTPUT THEN
    //                     LinesPrinted := LinesPrinted + 1;
    //             end;
    //         }
    //         dataitem(Cession; "Salary Lines")
    //         {
    //             DataItemLink = "No." = FIELD("No."),
    //                                Employee = FIELD(Employee);
    //             DataItemTableView = SORTING("No.", Employee)
    //                                     ORDER(Ascending);
    //             column(Cession_Cession; Cession)
    //             {
    //             }
    //             column("Reste_Montant_Solde_Congé_NégatifCaption"; Reste_Montant_Solde_Congé_NégatifCaptionLbl)
    //             {
    //             }
    //             column(Cession_No_; "No.")
    //             {
    //             }
    //             column(Cession_Employee; Employee)
    //             {
    //             }
    //             trigger OnAfterGetRecord()
    //             begin

    //                 IF Cession <> 0 THEN IntCompteur += 1;
    //                 if "Salary Lines".Cession = 0 then
    //                     CurrReport.Skip();
    //                 //  CurrReport.SHOWOUTPUT("Salary Lines".Cession <> 0);
    //                 //IF CurrReport.SHOWOUTPUT THEN
    //                 //LinesPrinted := LinesPrinted + 1;
    //             end;
    //         }
    ...
    //             trigger OnPreDataItem()
    //             begin
    //                 SETRANGE(Number, 1, (30 - LinesPrinted));
    //             end;
    //         }
    ...
    //     Prime_De_Rendement_2019CaptionLbl: Label 'Prime De Rendement 2019';
    //     MontantCaptionLbl: Label 'Montant';
    //     "Total_Avance___CongéCaptionLbl": Label 'Total Avance / Congé';
    ...
    //     "Reste_Montant_Solde_Congé_NégatifCaptionLbl": Label 'Reste Montant Solde Congé Négatif';
}
