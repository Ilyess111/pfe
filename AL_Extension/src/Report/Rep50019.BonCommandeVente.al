report 50019 "Bon Commande Vente"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/BonCommandeVente2.rdl';
    Caption = 'Bon Commande Vente';
    dataset
    {
        dataitem("Sales Header"; 36)
        {
            ...
            dataitem(CopyLoop; 2000000026)
            {
                ...
                dataitem(PageLoop; 2000000026)
                {
                    ...
                    column(FACTURE_______Sales_Header___No__; 'FACTURE  ' + "Sales Header"."No.")
                    {
                    }
