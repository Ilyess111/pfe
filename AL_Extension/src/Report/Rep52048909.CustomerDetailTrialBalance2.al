...
report 52048909 "Customer Detail Trial Balance2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/CustomerDetailTrialBalance2.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'Grand livre clients Copie';
        ...
        dataitem(Customer; Customer)
        {
            ...
            dataitem(Date; Date)
            {
                ...
                dataitem("Detailed Cust. Ledg. Entry"; "Detailed Cust. Ledg. Entry")
                {
                    ...
                    column(Lettre; OriginalLedgerEntry2.Lettre)
                    {
                    }
    ...
    var
        ...
        CodeDevise: Code[20];
        OriginalLedgerEntry2: Record "Cust. Ledger Entry";
        BollGLettré: Boolean;
        YouSkip: Boolean;
        OriginalLedgerEntry3: Record "Cust. Ledger Entry";
