report 50021 "Bon Déchargement"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/BonDéchargement.rdl';
    Caption = 'Bon Déchargement';
    dataset
    {
        dataitem("Sales Header"; 36)
        {
            ...
            dataitem(CopyLoop; 2000000026)
            {
                ...
                dataitem(PageLoop; 2000000026)
                {
                    ...
                    column(FACTURE_______Sales_Header___No__; 'Bon Déchargement  ' + "Sales Header"."No.")
                    {
                    }
               ...
               begin
                   IF NOT ShowInternalInfo THEN
                    ...
                    dataitem("Sales Line"; 37)
                    {
                        ...
                        column(Sales_Line__Sales_Line___Unit_Cost__LCY__; "Sales Line"."Unit price")
                        {
                            AutoFormatType = 2;
                        }
                ...
                IF RecSalesLine.FINDFIRST THEN
                    REPEAT
                        ...
                        IF RecSalesLine."No." <> SalesReceivablesSetup."Frais BIC" THEN BEGIN
                            ...
                            DecAcompte += RecSalesLine."Prepmt. Line Amount";
                            DecMontantTVA += RecSalesLine."Amount Including VAT" - RecSalesLine.Amount;
    ...
    var
        ...
        "Arrêté_la_présente_facture_à_la_somme_CaptionLbl": Label 'Arrêté la présente Bon déchargement à la somme:';
