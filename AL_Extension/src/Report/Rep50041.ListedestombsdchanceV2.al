report 50041 "Liste des tombés d'échéance V2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/ListedestombésdéchéanceV2.rdlc';
    ...
    dataset
    {
        dataitem(DataItem3474; 10866)
        {
            ...
            begin
                IF RIBBanque.GET("DataItem3474"."Compte Bancaire") THEN;
            ...
            begin
                ...
                "DataItem3474".SETFILTER("DataItem3474"."Due Date", '>=%1&<=%2', DateRec, DateDep);
            end;
        }
    }
    ...
    begin
        ...
        ExcelBuf.AddInfoColumn(REPORT::"Suivi Mouvement Transfert", FALSE, FALSE, FALSE, FALSE, '', 0); // JBS // Replace 50042 with the correct report ID
        ExcelBuf.NewRow;
    ...
    begin
        ...
        ExcelBuf.NewRow;
        ExcelBuf.AddColumn(FORMAT("DataItem3474".Banque), FALSE, '', FALSE, FALSE, FALSE, '', 0);
        // ExcelBuf.AddColumn(RIBBanque.RIB,FALSE,'',FALSE,FALSE,FALSE,'',0);
        ExcelBuf.AddColumn("DataItem3474"."External Document No.", FALSE, '', FALSE, FALSE, FALSE, '', 0);
        ExcelBuf.AddColumn("DataItem3474".Amount, FALSE, '', FALSE, FALSE, FALSE, '', 0);
        ExcelBuf.AddColumn("DataItem3474"."Due Date", FALSE, '', FALSE, FALSE, FALSE, '', 0);
        ExcelBuf.AddColumn("DataItem3474"."Drawee Reference", FALSE, '', FALSE, FALSE, FALSE, '', 0);
    end;
    ...
    begin
        ...
        ExcelBuf.CreateNewBook('Liste des tombÚs');
        // JBS
        //GL2024  ExcelBuf.CreateSheet(Text001,Text002,COMPANYNAME,USERID);
        // ExcelBuf.GiveUserControl; // JBS
        ExcelBuf.OpenExcel();
        ERROR('');
    end;
}