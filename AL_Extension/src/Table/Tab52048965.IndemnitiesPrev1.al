table 52048965 "Indemnities Prev1"
{//GL2024  ID dans Nav 2009 : "39001462"
    ...
    fields
    {
        ...
        field(7; "Evaluation mode"; Option)
        {
            ...
            OptionCaption = 'Inclusive,on Paid period,on Worked period,on Worked hour,on Flight hours,Nbre Days Worked,Montant = Brut * Taux,Montant = Base * Taux';
            OptionMembers = Inclusive,"on Paid period","on Worked period","on Worked hour","on Flight hours","Nbre Days Worked","Montant = Brut * taux","Montant = Base * Taux";
        }
