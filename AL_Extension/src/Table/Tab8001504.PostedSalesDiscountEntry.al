Table 8001504 "Posted Sales Discount Entry"
{
    // //+RFA+ GESWAY 11/07/02 Table de stockage des remises des lignes vente enregistrées.

    Caption = 'Posted Sales Discount Entry';
    // DrillDownPageID = 8001504;
    // LookupPageID = 8001504;
