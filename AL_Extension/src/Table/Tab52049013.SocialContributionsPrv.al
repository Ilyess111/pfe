table 52049013 "Social Contributions Prév"
{ //GL2024  ID dans Nav 2009 : "39001485"
    Caption = 'Social Contribution';
    //GL2026DrillDownPageID = "Cotisation soc. ln slr Prév.";
    // LookupPageID = "Cotisation soc. ln slr Prév.";
