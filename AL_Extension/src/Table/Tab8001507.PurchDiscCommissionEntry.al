Table 8001507 "Purch. Disc. Commission Entry"
{
    // //+RFA+ GESWAY 11/07/02 Nouvelle table de stockage des commissions remises calculées a posteriori.

    Caption = 'Purch. Discount and Comm. Entry';
    // DrillDownPageID = 8001511;
    // LookupPageID = 8001511;
    ...
    fields
    {
        ...
        field(41; "Global Dimension 1 Code"; Code[10])
        {
            //CaptionClass = '1,1,1';
            Caption = 'Global Dimension 1 Code';
        }
        field(42; "Global Dimension 2 Code"; Code[10])
        {
            //CaptionClass = '1,1,2';
        ...
        field(101; "Create Credit Memo"; Option)
        {
            ...
            OptionCaption = 'Not,Immediate,Forward';
            OptionMembers = "Not",Immediate,Forward;
        }
