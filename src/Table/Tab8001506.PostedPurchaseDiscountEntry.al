Table 8001506 "Posted Purchase Discount Entry"
{
    // //+RFA+ GESWAY 11/07/02 Nouvelle table de stockage des remises des lignes achat enregistrées

    Caption = 'Posted Purchase Discount Entry';
    //  DrillDownPageID = 8001508;
    // LookupPageID = 8001508;
    ...
    fields
    {
        ...
        field(10; "Continue Calculation"; Option)
        {
            ...
            OptionCaption = 'Yes,Line Discount,Invoice Discount,End of Period,No';
            OptionMembers = Yes,"Line Discount","Invoice Discount","End of Period",No;
        }
