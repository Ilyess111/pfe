Table 8001503 "Sales Disc. Commission Entry"
{
    ...
    keys
    {
        key(Key1; "Disc. Commission Type", "Rule No.", "Salesperson Code", "Customer No.", "Location Code", "Global Dimension 1 Code", "Global Dimension 2 Code", "Cust. Posting Group", "Gen. Bus. Posting Group", "Inventory Posting Group", "Gen. Prod. Posting Group", "Price Group Code")
        {
            Clustered = true;
