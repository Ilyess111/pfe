Table 8001907 "Sales Contract Gain/Loss Entry"
{
    // //+ABO+VALUE CW 02/06/11 Copy from SalesLine (without any code), keep field IDs for TransferFields

    Caption = 'Sales Contract Gain/Loss Entry';
    //GL2024  DrillDownPageID =8001907;
    //GL2024   LookupPageID = 8001907;
    ...
    fields
    {
        ...
        field(8001910; "Type of Change"; Option)
        {
            Caption = 'Type of Change';
            OptionCaption = 'Released,Manual Update,Price Update,Canceled';
            OptionMembers = Released,"Manual Update","Price Update",Canceled;
        }
        field(8001911; "Change Date"; Date)
        {
            Caption = 'Change Date';
        }
        field(8001912; "User ID"; Code[20])
        {
            Caption = 'User ID';
            Editable = false;
            TableRelation = User;
        ...
        field(8001979; "Sell-to Customer Name"; Text[50])
        {
