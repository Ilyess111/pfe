Table 8001505 "Purchase Line Disc. Entry"
{
    // //+RFA+ GESWAY 11/07/02 Nouvelle table de stockage des remises des lignes achat.

    Caption = 'Purchase Line Discount Entry';
    //  DrillDownPageID = 8001507;
    // LookupPageID = 8001507;
