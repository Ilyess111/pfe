page 50029 "Fiche Provisoire"
{
    Caption = 'Provisoire';
    Description = 'Fiche Provisoire Saige';
    DeleteAllowed = true;
    PageType = Card;
...
// Page 50029 "Bareme Bleu"
// {
//     // PageType = List;
//     // SourceTable = "Bareme Bleu";
//     // Caption = 'Bareme Bleu';
//     // ApplicationArea = all;
//     // UsageCategory = Lists;
//     // layout
...
//     //         {
//     //             ShowCaption = false;
//     //             field("Classe Immo"; rec."Classe Immo")
//     //             {
//     //                 ApplicationArea = all;
//     //             }
...
//     //                 ApplicationArea = all;
//     //             }
//     //             field("Annee Acquistion (0)"; rec."Annee Acquistion (0)")
//     //             {
//     //                 ApplicationArea = all;
//     //             }
//     //             field("Mois Acquistion (0)"; rec."Mois Acquistion (0)")
//     //             {
//     //                 ApplicationArea = all;
//     //             }
//     //             field("Cout Acquisition (T0)"; rec."Cout Acquisition (T0)")
//     //             {
//     //                 ApplicationArea = all;
//     //             }
//     //             field("IM(0)"; rec."IM(0)")
...
//     //                 ApplicationArea = all;
//     //             }
//     //             field("Annee Acquistion (T)"; rec."Annee Acquistion (T)")
//     //             {
//     //                 ApplicationArea = all;
//     //             }
//     //             field("Mois Acquistion (T)"; rec."Mois Acquistion (T)")
//     //             {
//     //                 ApplicationArea = all;
//     //             }
//     //             field("Cout Acquisition (Ti)"; rec."Cout Acquisition (Ti)")
//     //             {
//     //                 ApplicationArea = all;
//     //             }
//     //             field(T; rec.T)
