//GL2024
// page 50119 "Caisse Extra AUTOR SBIKHA LO5"
// {
...
//     SourceTableView = WHERE("Payment Class" = CONST('CAISSEEXT'), Valider = CONST(false), "Caisse Chantier" = CONST(false), "N° Affaire" = FILTER(= 'AUTOROUTE SBIKHA LO5' | ''));
//     Caption = 'Caisse Extra AUTOR SBIKHA LO5';
//     ApplicationArea = all;
