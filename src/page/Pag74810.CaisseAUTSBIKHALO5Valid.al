//GL2024
// page 74810 "Caisse AUT SBIKHA LO5 Validé"
// {//GL2024  ID dans Nav 2009 : "39004810"
...
//     SourceTableView = WHERE("Payment Class" = CONST('CAISSEEXT'), Valider = CONST(true), "Caisse Chantier" = CONST(false), "N° Affaire" = FILTER('AUTOROUTE SBIKHA LO5' | ''));
//     ApplicationArea = all;
