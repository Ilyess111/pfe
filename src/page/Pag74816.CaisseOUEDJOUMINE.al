//GL2024
// page 74816 "Caisse OUED_JOUMINE"
// {//GL2024  ID dans Nav 2009 : "39004816"
...
//     SourceTableView = WHERE("Payment Class" = CONST('CAISSEEXT'), Valider = CONST(false), "Caisse Chantier" = CONST(false), "N° Affaire" = FILTER('OUED_JOUMINE_MATEUR' | ''));
//     ApplicationArea = all;
