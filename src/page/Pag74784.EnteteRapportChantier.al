// page 74784 "Entete Rapport Chantier"
// {//GL2024  ID dans Nav 2009 : "39004784"
//     SourceTable = "Entete Rapport Chantier";
//     SourceTableView = WHERE(Statut = CONST(Ouvert),
//                             "Sous Traitant" = FILTER(false));
//     ApplicationArea = All;
...
//                         Caption = '<Cout Total>';
//                     }
//                     field("Cout Exe Uni"; REC."Cout Unitaire Exécuté")
//                     {
//                         ApplicationArea = All;
//                     }
//                 }
...
//                     }
//                 }
//                 part(MO; "Ligne rapport Chantier MO")
//                 {
//                     ApplicationArea = All;
//                     SubPageLink = "N° Document" = FIELD("N° Document");
//                 }
//                 part(MATERIEL; "Ligne rapport Chantier Engins")
//                 {
//                     ApplicationArea = All;
//                     SubPageLink = "N° Document" = FIELD("N° Document");
//                 }
