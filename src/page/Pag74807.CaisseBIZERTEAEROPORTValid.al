//GL2024
// page 74807 "Caisse BIZERTE AEROPORT Validé"
// {//GL2024  ID dans Nav 2009 : "39004807"
...
//     SourceTableView = WHERE("Payment Class" = CONST('CAISSEEXT'), Valider = CONST(true), "Caisse Chantier" = CONST(false), "N° Affaire" = FILTER('BIZERTE_BASE_AERIEN' | ''));
//     ApplicationArea = All;
