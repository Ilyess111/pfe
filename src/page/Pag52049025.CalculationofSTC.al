// page 52049025 "Calculation of  STC"
// {
//     //GL2024  ID dans Nav 2009 : "39001553"
//     Caption = 'Calcul STC';
//     PageType = Card;
...
//                     ApplicationArea = all;
//                 }
//                 field("Loans repaiment total3"; rec."Loans repaiment total")
//                 {
//                     ApplicationArea = all;
//                 }
//                 field("Advances repaiment total3"; rec."Advances repaiment total")
//                 {
//                     ApplicationArea = all;
//                 }
...
//             {
//                 Caption = 'Imprimer';
//                 actionref("Fiche de paie Matricielle SETT1"; "Fiche de paie Matricielle SETT")
//                 {

//                 }
//                 actionref("Fiche de paie Matricielle SORO1"; "Fiche de paie Matricielle SORO")
//                 {

//                 }
//                 actionref("Fiche de paie Matricielle FC1"; "Fiche de paie Matricielle FC")
//                 {
...
//                         Header.SETRANGE("No.", rec."No.");
//                         IF Header.FIND('-') THEN
//                             // REPORT.RUNMODAL(39001401, TRUE, TRUE, Header);
...
//         FillPaymentForm: report "Payroll : Fill Payment Form @";
...
//         Text19041875: Label 'Employee Average cost';
