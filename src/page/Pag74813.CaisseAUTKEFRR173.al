//GL2024
// page 74813 "Caisse AUT KEF RR173"
// {//GL2024  ID dans Nav 2009 : "39004813"
...
//     SourceTableView = WHERE("Payment Class" = CONST('CAISSEEXT'), Valider = CONST(false), "Caisse Chantier" = CONST(false), "N° Affaire" = FILTER('CHANTIER_KEF_RR173' | ''));
//     ApplicationArea = all;
