// Page 50186 "Liste Rejet Salaire"
// {
//     Editable = true;
//     InsertAllowed = false;
//     PageType = List;
...
//                             Type = filter("Rejet Salaire"));
//     ApplicationArea = all;
//     Caption = 'Liste Rejet Salaire';
//     layout
//     {
//         area(content)
//         {
...
//                         RecPaymentLineDest.Validate("Debit Amount", Abs(RecEnteteLotPaieSelect."Mantant Net"));
//                         RecLigneLotPaie.SetRange(Code, RecEnteteLotPaieSelect.Code);
//                         RecLigneLotPaie.SetRange(Type, RecLigneLotPaie.Type::"Rejet Salaire");
//                         if RecLigneLotPaie.FindFirst then
//                             RecPaymentLineDest.Validate(Salarié, RecLigneLotPaie."Matricule Salarié");
//                         RecPaymentLineDest.Libellé := 'Rejet SALAIRE ' + Format(RecEnteteLotPaieSelect.Mois) + ' ' + Format(RecEnteteLotPaieSelect.Annee);
