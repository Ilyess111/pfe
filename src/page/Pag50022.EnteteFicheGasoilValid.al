page 50022 "Entete Fiche Gasoil Validé"
{
    ...
    layout
    {
        area(content)
        {
            group("FICHE DE STOCK DE GAS-OIL")
            {
                Caption = 'FICHE DE STOCK DE GAS-OIL';
                field("No."; rec."No.")
                {
                    ApplicationArea = all;
                ...
                field("Cuve"; rec.Cuve)
                {
                    ...
                    begin
                        ...
                        // RecLigneFicheGasoil.SETRANGE("No.", rec."No.");
                        // IF RecLigneFicheGasoil.FINDFIRST THEN
                        //     ERROR('Impossible de changer la cuve car des lignes existent déjà pour cette fiche.');
                        IntIndexDebut := 0;
                        rec.Journee := TODAY;
            ...
            part(SubGasoil; "Ligne Fiche Gasoil")
            {
                ApplicationArea = all;
                Caption = 'Ligne Fiche Gasoil';
                Editable = SubGasoilEDITABLE;
        ...
        area(creation)
        {
            group(Fonction)
            {
                    ...
                    begin
                        ...
                        IF RecLigneFicheGasoil.FINDFIRST THEN
                            REPEAT
                                ...
                                //   RecItemJournalLine."Lieu De Livraison / Provenance" := RecLigneFicheGasoil.Affaire;
                                ...
                                IF RecVéhicule.GET(RecLigneFicheGasoil.Materiel) THEN BEGIN
                                    ...
                                    RecPriseCarburantEnregistré.INSERT;
                                    // Prise Carburant
                                END;
                ...
                action(Imprimer)
                {
                    ...
                    trigger OnAction()
                    var
                        RepFicheStockGasoil: Report "Fiche Stock Gasoil";
                    begin

                        RecEnteteGasoil.SETRANGE("No.", Rec."No.");
    ...
    var
        ...
        Text001: Label 'Valider la journée ?';
    ...
    procedure InitRecord1()
    var
        lNoteOfExpensesIntegr: Codeunit "Note of Expenses integr.";
    begin
        NoSeriesMgt.SetDefaultSeries(rec."No.", RecInventorySetup."Fiche Gasoil Nos.");
    end;


    procedure AssistEdit1(OldPurchHeader: Record "Purchase Header"): Boolean
    begin
    end;
    ...
    // lSubscrSetup: Record 8001900;
    begin
        EXIT(RecInventorySetup."Fiche Gasoil Nos.");
    end;
