page 50072 "Alerte  Assurance Vehicule 02"
{
    Editable = false;
    PageType = Card;
    ...
    trigger OnOpenPage()
    begin
        rec.SETRANGE("Date Expiration Assurance", TODAY, TODAY + 35);
        IF rec.COUNT = 0 THEN CurrPage.CLOSE;
    end;

    var
        Text19014127: Label '************************** ALERTE ASSURANCE VEHICULE ECHU ********************************';
}
