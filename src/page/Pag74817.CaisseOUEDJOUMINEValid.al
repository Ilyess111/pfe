//GL2024
// page 74817 "Caisse OUED_JOUMINE Validé"
// {//GL2024  ID dans Nav 2009 : "39004817"
...
//     SourceTableView = WHERE("Payment Class" = CONST('CAISSEEXT'), Valider = CONST(true), "Caisse Chantier" = CONST(false), "N° Affaire" = FILTER('OUED_JOUMINE_MATEUR' | ''));
//     ApplicationArea = all;
