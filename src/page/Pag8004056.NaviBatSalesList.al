page 8004056 "NaviBat Sales List"
{
    ...
    Caption = 'NaviBat Sales List';
    PageType = List;
    SaveValues = true;
    SourceTable = "Sales Header";
    //CardPageId = "DA Chantier Materiaux";
    //GL2024
    SourceTableView = SORTING("Order Type", "Document Type", "No.") WHERE("Document Type" = FILTER(Order), "Order Type" = CONST("Supply Order"), "Type Demande" = CONST(Materiaux));
    //GL2024
    ApplicationArea = all;
    UsageCategory = Lists;
    ...
    layout
    {
        area(content)
        {
            ...
            /*GL2024   part("Reordering Requisition Subform"; "Reordering Requisition Subform")
               {
                   subpageview ="Document No." =FIELD("No."),"Document Type"=FIELD("Document Type")
               }*/
        }
