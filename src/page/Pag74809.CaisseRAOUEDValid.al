//GL2024
// page 74809 "Caisse RAOUED Validé"
// {//GL2024  ID dans Nav 2009 : "39004809"
...
//     SourceTableView = WHERE("Payment Class" = CONST('CAISSEEXT'), Valider = CONST(true), "Caisse Chantier" = CONST(false), "N° Affaire" = FILTER('PORT FINA RAOUED RP2' | ''));
//     ApplicationArea = all;
