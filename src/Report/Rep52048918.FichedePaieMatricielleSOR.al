report 52048918 "Fiche de Paie Matricielle SOR@"
{
    // //GL2024 Dans nav2009 id "39001490"

    // // 106
    // DefaultLayout = RDLC;
    // RDLCLayout = './Layouts/FichedePaieMatricielleSOR.rdl';
    ...
    //             {
    //             }
    //             column(nom_Control1120028; nom)
    //             {
    //             }
    //             column(CompInfo_Address_Control1120033; CompInfo.Address)
    //             {
    //             }
    //             column(Nss_Control1120035; Nss)
    //             {
    //             }
    //             column(Salary_Headers1_Year_Control1120040; Year)
    //             {
    //             }
    //             column(Salary_Headers1_Month_Control1000000049; Month)
    //             {
    //             }
    //             column(SOLDE_DE_TOUT_COMPTE_Caption; SOLDE_DE_TOUT_COMPTE_CaptionLbl)
    //             {
    //             }
    ...
    //             {
    //             }
    //             column(Typedocument_____DesgCNSS; Typedocument + ' ' + DesgCNSS)
    //             {
    //                 //  DecimalPlaces = 0 : 1;
    //             }
    //             column("Réf_____NumBonCaisse"; '   Réf:  ' + NumBonCaisse)
    //             {
    //                 // DecimalPlaces = 0 : 1;
    //             }
    ...
    //                     /*
    //                       // IF RecLoanAdvanceHeaderCNSS."Pret CNSS" <> RecLoanAdvanceHeaderCNSS."Pret CNSS"::" " THEN
    //                       // BEGIN
    ...
    //                         DesgCNSS := FORMAT(RecLoanAdvanceHeaderCNSS."Pret CNSS")
    //                     END;


    //                 END;
    //                 // RB SORO 04/05/2016
    //                 IF DesgCNSS = 'Cession' THEN Typedocument := '';
    //                 IF DesgCNSS <> 'Cession' THEN Typedocument := "Document type";
    ...
    //     Typedocument: Text[30];
    //     RecLoanAdvanceHeader: Record "Loan & Advance Header";
    //     NumBonCaisse: Code[20];
    //     SOLDE_DE_TOUT_COMPTE_CaptionLbl: Label 'SOLDE DE TOUT COMPTE ';
