report 50152 "Remplir Declaration Employeur"
{
    // DefaultLayout = RDLC;
    // RDLCLayout = './Layouts/RemplirDeclarationEmployeur.rdlc';
    ...
    //             //GL2024
    //             if "G/L Entry"."G/L Account No." <> "No compte" then begin
    //                 Montant := 0;
    //                 GRecDeclaration."Mnt Brut" := 0;
    //                 GRecDeclaration."Mnt Net" := 0;
    //                 "No compte" := "G/L Entry"."G/L Account No.";

    //             end
    //             else
    //                 if "G/L Entry"."Source No." <> Origine then begin
    //                     Montant := 0;
    //                     GRecDeclaration."Mnt Brut" := 0;
    //                     GRecDeclaration."Mnt Net" := 0;
    //                     Origine := "G/L Entry"."Source No.";
    //                 end;
    //             //GL2024
    ...
    //                     GRecDeclaration2.SETRANGE("Code Tiers", "Source No.");
    //                     GRecDeclaration2.SETFILTER(CGC, '<>%1', 0);
    //                     IF NOT GRecDeclaration2.FINDFIRST THEN BEGIN
    ...
    //             /*GL2024     GRecDeclaration."Mnt Brut" := 0;
    //                  GRecDeclaration."Mnt Net" := 0;*/
    //             GRecParaDec.RESET;
    ...
    //             //SETFILTER("Source Type",'Fournisseur');
    ...
    //                 {
    //                     ApplicationArea = All;
    //                     ToolTip = 'Filtrer les données pour une année spécifique.';
    //                     Caption = 'Année';
    //                 }
    //             }
    //         }
