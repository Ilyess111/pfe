Report 50159 "Facture Vente enregistré2"
{
    // // //
    // DefaultLayout = RDLC;
    // RDLCLayout = './Layouts/Facture Vente enregistré2.rdlc';
               ...
               begin
                   IF NOT ShowInternalInfo THEN
                    ...
                    dataitem("Sales Line"; 37)
                    {
                        ...
                        column(Sales_Line__Sales_Line___Unit_Cost__LCY__; "Sales Line"."Unit Cost (LCY)")
                        {
                            AutoFormatType = 2;
                        }
