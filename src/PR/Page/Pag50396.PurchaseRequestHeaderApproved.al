Page 50396 "PurchaseRequestHeaderApproved"
{
    // HS
    Caption = 'Demande d''Achats Approuvée';
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            ...
            part("PurchaserequestLine"; "Purchase request LineApproved")
            {
                ApplicationArea = all;
    ...
    actions
    {
        ...
        area(processing)
        {
            ...
            group(BFUNCTION)
            {
                ...
                {
                    ApplicationArea = Basic;
                    Caption = 'Créer Commande d''Achat';
                    Image = Purchase;
                    Promoted = true;
                    PromotedCategory = Process;
                    trigger OnAction()
                    var
                        ...
                        Txt0003: Label 'Le statut de la PR doit être approuvé';
                    begin
                        //HS
                ...
                action("Re&lease")
                {
                    ...
                    var
                        ...
                        l_Note: BigText;
                        Txt0004: Label 'Send purchase request %1 by %2';
                ...
                action(denied)
                {
                    ...
                    var
                        RecPrLine: Record "Purchase request Line";
                        Txt0001: Label 'Vous n''êtes pas autorisé à changer le statut de la demande en "Refusé".';
                        RecGUserSetup: Record "User Setup";
    ...
    var
        ...
        Text000: label 'Exécution impossible en mode lecture seule.';
        ...
        LeMessage: Text[200];
        Text002: label 'Nouvelle Demande d''Achat No. %1  Envoyée par %2';
        Text003: label 'Notification déjà envoyée';
        Text004: label 'Le statut PR ne permet pas l’impression.';
        Text005: label 'Archiver cette demande d’achat ?';
        Text006: label 'Le statut doit être valide pour pouvoir archiver ?';
        PurchaseHeader: Record "Purchase Header";
        PurchaseLine: Record "Purchase Line";
        NbrLigne: Integer;
        NbrLigneOrigine: Integer;
        PurchaseReqLine: Record "Purchase request Line";
        Text007: label 'Aucune ligne dans la DR';
        Text008: label 'DR déjà engagée';
        Text009: label 'DR liée à un bon de commande';
        Text010: label 'Aucune modification autorisée - statut non ouvert';
        Text011: label 'Interdiction totale dans le module DR';
