...
codeunit 52048901 "Payment-ApplyCopy"
{
    ...
    begin
        ...
        //GL2024  PaymentLine.GetCurrency();
    ...
    var
        Text001: Label 'Remplacement de %1 %3 par %4 dans %2.\';
        Text002: Label 'Souhaitez-vous continuer ?';
        Text003: Label 'La mise à jour a été interrompue pour respecter l''alerte.';
        Text005: Label '%1 ou %2 doit être un client ou un fournisseur.';
        Text006: Label 'La même devise doit être utilisée pour toutes les écritures lettrage.';
        Text007: Label 'Toutes les écritures d''une même application doivent être indiquées dans la même devise ou dans une ou plusieurs devises UME. ';
        ...
        if CustLedgEntry.Find('-') then begin
            ...
            if GenJnlLine.Amount = 0 then begin
                repeat
                    ...
                    /*GL2024    CustLedgEntry."Amount to Apply" :=
                            CurrExchRate.ExchangeAmount(
        ...
        if VendLedgEntry.Find('+') then begin
            ...
            if GenJnlLine.Amount = 0 then begin
                repeat
                    ...
                    /*GL2024   VendLedgEntry."Amount to Apply" :=
                           CurrExchRate.ExchangeAmount(
