//HS
xmlport 50106 "Disquette Virement BNA Enreg"
{
    ...
    //                 LigneLotPaie.SETRANGE(Code, CodeLotVirement);
    //                 IF LigneLotPaie.FINDFIRST THEN
    //                     IF EnteteSalaire.GET(LigneLotPaie."Num Paie") THEN
    //                         NumPaie := EnteteSalaire."No.";

    //                 RecSalaryLines.SETFILTER("No.", NumPaie);
    //                 RecSalaryLines.SETFILTER("Ordre Virement Salaire", CodeLotVirement);    //"Lot Virement Salaire"
    //             end;
    ...
    //                         CodeInstSal := COPYSTR(SalaryLines.RIB, 1, 2);
    //                         CodeAgenceSal := COPYSTR(SalaryLines.RIB, 3, 3);
    ...
    //     infosoc.GET;
    //     EnteteSalaire.RESET;
    //     IF EnteteSalaire.GET(LigneLotPaie."Num Paie") THEN BEGIN
    //         NumPaie := EnteteSalaire."No.";
    //         SalaryLines.RESET;
    ...
    //     MontantN2: Code[15];
    //     "---Mehdi MSF---": Integer; // Remplacé "---Mehdi MSF---"
    //     "---Global---": Integer; // Remplacé "---Global---"
    //     // Sens: Code[1];
    ...
    //     // Rang: Code[2];
    //     Filler: Code[155];
    //     "---Detail---": Integer; // Remplacé "---Detail---"
    //     CodeEnreDet: Code[2];
    //     // MontantVir: Code[15];
    //     // NumVir: Code[7];
    //     // RibSoc: Code[20];
