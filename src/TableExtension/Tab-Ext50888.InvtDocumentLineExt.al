tableextension 50888 "Invt. Document Line Ext" extends "Invt. Document Line"
{
    fields
    {
        ////From 2009
        ...
        field(50008; Utilisateur; Code[50])
        {
            Description = 'HJ DSFT 26-03-2012';
        }
    ...
    var
        fff: Record 83;
        RecInvtDocumentHeader: Record "Invt. Document Header";
    begin
        if RecInvtDocumentHeader.Get("Document Type"::Shipment, Rec."Document No.") then begin
            Rec."DYSJob No." := RecInvtDocumentHeader."DYSJob No.";
            Rec."DYSJob Task No." := RecInvtDocumentHeader."DYSJob Task No.";
            Rec."DYSJob Planning Line No." := RecInvtDocumentHeader."DYSJob Planning Line No.";
        end;
